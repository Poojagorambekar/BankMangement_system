...
public class SignupTwo extends JFrame implements ActionListener{
	...
	SignupTwo(String formno )
	{
		this.formno=formno;
		setLayout(null);
		setTitle("NEW ACCOCUNT APPLICATION FORM - PAGE 2");
	...
	add(name);
	String vailReligion[]= {"Hindu","Musalim","Sikh","Christain","other"};
	religion=new JComboBox(vailReligion);
	...
	String occupationValues[]= {"Salaried","Self-Employes","Business","Student","Retired","Others"};
